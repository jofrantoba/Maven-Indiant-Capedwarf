...
public class UiEstadisticaTuristaImpl extends UiEstadisticaTurista {			
	
	public UiEstadisticaTuristaImpl() {
		// TODO Auto-generated constructor stub		
	}
	
	@Override
	public void cargarDataGraficaProcedencia(String nacionalidad) {		
		MaterialToast.fireToast("hona munfo");
		...
		SERVICE.ieModaInteresTuristaByTuristaInteres(null, null, null, null, null, nacionalidad.toUpperCase(), new AsyncCallback<List<TuristaInteres>>() {			
			...
			public void onSuccess(List<TuristaInteres> result) {				
				MaterialToast.fireToast(result.size()+"");
//				TuristaInteres tur1= new TuristaInteres();
//				tur1.setValorModa(3.0);
//				tur1.setNacionalidad("PERU");
//				tur1.setNombreInteres("CAMINAR");
//				
//				TuristaInteres tur2= new TuristaInteres();
//				tur2.setValorModa(3.0);
//				tur2.setNacionalidad("ESPANA");
//				tur2.setNombreInteres("CORRER");
//				
//				TuristaInteres tur3= new TuristaInteres();
//				tur3.setValorModa(5.0);
//				tur3.setNacionalidad("BRASIL");
//				tur3.setNombreInteres("VENDER");
...
//				result.add(tur3);
				...
				if(result!=null){
					...
					if(result.size()>=3){
						...
						MaterialToast.fireToast(result.size()+"laaaaaaaaaa");
						initialize();		
					}
				}					
			}			
