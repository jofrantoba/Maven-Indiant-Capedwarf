...
public class UiMantTipoEmpatia extends UiMantenimiento implements InterUiMantTipoEmpatia{
	protected UiTipoEmpatiaImpl uiPadre;
	...
	protected TipoEmpatia bean;
	
	public UiMantTipoEmpatia(){
		initComponents();	
	}
	
	public UiMantTipoEmpatia(UiTipoEmpatiaImpl uiPadre){
		this.uiPadre=uiPadre;
		initComponents();	
	}
	
	private void initComponents(){		
		this.CardContTitulo.setText("Tipo Empatia");		
	...
	public void loadFields() {
		...
		if (this.modo.equals(UiMantenimiento.MODOUPDATE)) {
            ...
            txtId.setText(this.bean.getCodeTipoEmpatia());
        	...
        	lblId.setVisible(true);
        	txtId.setVisible(true);
            txtId.setText(this.bean.getCodeTipoEmpatia().toString());
            txtDescripcion.setText(this.bean.getDescripcion());
            swtEstado.setValue(this.bean.getEstado().equalsIgnoreCase("A")?true:false);
            txtId.setEnabled(false);
            txtDescripcion.setEnabled(false);
	...
	@Override
	public void updateDataGrid(TipoEmpatia bean) {
		// TODO Auto-generated method stub
		
	}	

	public void setBean(TipoEmpatia bean) {
		this.bean = bean;
	}
	...
	public boolean isExistInGrid() {
		// TODO Auto-generated method stub
		Iterator<TipoEmpatia> iterador=uiPadre.getGrid().getData().iterator();
		while(iterador.hasNext()){
			TipoEmpatia bean=iterador.next();
			if(bean.getCodeTipoEmpatia().equalsIgnoreCase(txtId.getText())){
				return true;
			}
		}
		return false;
