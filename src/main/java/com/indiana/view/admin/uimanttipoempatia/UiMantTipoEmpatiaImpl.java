...
public class UiMantTipoEmpatiaImpl extends  UiMantTipoEmpatia{	
	private final ServiceGestionMantenimientoAsync SERVICE = GWT.create(ServiceGestionMantenimiento.class);
	
	public UiMantTipoEmpatiaImpl(UiTipoEmpatiaImpl uiPadre){
		super(uiPadre);
	}
	...
	public void processInsertar() {
		...
		if (isValidData()) {
			TipoEmpatia bean=new TipoEmpatia();
			bean.setIdTipoEmpatia(txtId.getText().trim().toUpperCase());
			bean.setCodeTipoEmpatia(txtId.getText().trim().toUpperCase());
			...
			SERVICE.insertTipoEmpatia(bean, new AsyncCallback<TipoEmpatia>() {
				...
				@Override
				public void onSuccess(TipoEmpatia result) {
					// TODO Auto-generated method stub					
	...
	public void processActualizar() {
		...
		if (isValidData()) {
			TipoEmpatia bean=new TipoEmpatia();
			bean.setIdTipoEmpatia(this.bean.getIdTipoEmpatia());
			bean.setCodeTipoEmpatia(this.bean.getCodeTipoEmpatia());
			bean.setIsPersistente(this.bean.getIsPersistente());
			bean.setDescripcion(txtDescripcion.getText().trim().toUpperCase());		
			bean.setEstado(swtEstado.getValue()?"A":"D");
			bean.setOperacion("A");
			bean.setVersion((new Date()).getTime());
			SERVICE.updateTipoEmpatia(bean, new AsyncCallback<TipoEmpatia>() {
