...
public class UiEstadTurista extends FlexTable implements InterUiEstadTurista{
	...
	private static final String RANGO_EDAD_DEFECTO="18-22";
	public PieChart chart = null;
	
	public UiEstadTurista() {
		initComponents();
		initListener();
		initStyle();
	}
...
//			returnConentFlex().setWidget(0, 2, flexLeft3Chart);
	...
	public void llenarComboBox() {		
		...
		comboBoxGrupoEtario.addItem("18-22");
		comboBoxGrupoEtario.addItem("22-35");
		comboBoxGrupoEtario.addItem("35-45");
	}
