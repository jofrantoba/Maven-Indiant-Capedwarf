...
public class UiMantIdioma extends UiMantenimiento implements InterUiMantIdioma{
	protected UiIdiomaImpl uiPadre;
	...
	protected Idioma bean;
	
	public UiMantIdioma(){
		initComponents();	
	}
	
	public UiMantIdioma(UiIdiomaImpl uiPadre){
		this.uiPadre=uiPadre;
		initComponents();	
	}
	
	private void initComponents(){		
		this.CardContTitulo.setText("Idioma");		
	...
	public void loadFields() {
		...
		if (this.modo.equals(UiMantenimiento.MODOUPDATE)) {
            ...
            txtId.setText(this.bean.getCodeIdioma());
        	...
        	lblId.setVisible(true);
        	txtId.setVisible(true);
            txtId.setText(this.bean.getCodeIdioma().toString());
            txtDescripcion.setText(this.bean.getDescripcion());
            txtId.setEnabled(false);
            txtDescripcion.setEnabled(false);
	...
	public void setBean(Idioma bean) {
		this.bean = bean;
	}
	...
	public boolean isExistInGrid() {
		// TODO Auto-generated method stub
		Iterator<Idioma> iterador=uiPadre.getGrid().getData().iterator();
		while(iterador.hasNext()){
			Idioma bean=iterador.next();
			if(bean.getCodeIdioma().equalsIgnoreCase(txtId.getText())){
				return true;
			}
		}
		return false;
