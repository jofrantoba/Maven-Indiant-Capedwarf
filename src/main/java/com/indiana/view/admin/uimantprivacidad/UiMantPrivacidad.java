...
public class UiMantPrivacidad extends UiMantenimiento implements InterUiMantPrivacidad{
	protected UiPrivacidadImpl uiPadre;
	...
	protected Privacidad bean;
	
	public UiMantPrivacidad(){
		initComponents();	
	}
	
	public UiMantPrivacidad(UiPrivacidadImpl uiPadre){
		this.uiPadre=uiPadre;
		initComponents();	
	}
	
	private void initComponents(){		
		this.CardContTitulo.setText("Privacidad");		
	...
	public void loadFields() {
		...
		if (this.modo.equals(UiMantenimiento.MODOUPDATE)) {
            ...
            txtId.setText(this.bean.getCodePrivacidad());
        	...
        	lblId.setVisible(true);
        	txtId.setVisible(true);
            txtId.setText(this.bean.getCodePrivacidad().toString());
            txtDescripcion.setText(this.bean.getDescripcion());
            txtId.setEnabled(false);
            txtDescripcion.setEnabled(false);
	...
	public void setBean(Privacidad bean) {
		this.bean = bean;
	}
	...
	public boolean isExistInGrid() {
		// TODO Auto-generated method stub
		Iterator<Privacidad> iterador=uiPadre.getGrid().getData().iterator();
		while(iterador.hasNext()){
			Privacidad bean=iterador.next();
			if(bean.getCodePrivacidad().equalsIgnoreCase(txtId.getText())){
				return true;
			}
		}
		return false;
