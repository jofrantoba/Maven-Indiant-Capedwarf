...
public class TaskMuroNoticiaCompartirNoticia extends HttpServlet {
	private static final Logger _logger = Logger.getLogger(TaskMuroNoticiaCompartirNoticia.class.getName());
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		try {		
			...
			GestionMiembro.queueMuroNoticiaNovedadColonia(codeNoticia);
			_logger.info("Exito");		
