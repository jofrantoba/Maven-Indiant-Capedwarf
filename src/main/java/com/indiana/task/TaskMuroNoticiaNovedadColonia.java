...
public class TaskMuroNoticiaNovedadColonia extends HttpServlet {
	private static final Logger _logger = Logger.getLogger(TaskMuroNoticiaNovedadColonia.class.getName());
