...
public class TaskNotificacionNovedadColonia extends HttpServlet {
	private static final Logger _logger = Logger.getLogger(TaskNotificacionNovedadColonia.class.getName());
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		try {		
			...
			GestionMiembro.queueNotificationNovedadColonia(codeNotificacion);			
			_logger.info("Exito");		
