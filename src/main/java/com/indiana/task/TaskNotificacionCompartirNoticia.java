...
public class TaskNotificacionCompartirNoticia extends HttpServlet {
	private static final Logger _logger = Logger.getLogger(TaskNotificacionCompartirNoticia.class.getName());
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		try {		
			...
			GestionTurista.queueNotificationNoticiaCompartida(codeNotificacion);		
			_logger.info("Exito");		
