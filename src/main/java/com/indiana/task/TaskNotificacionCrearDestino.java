...
public class TaskNotificacionCrearDestino extends HttpServlet {
	private static final Logger _logger = Logger.getLogger(TaskNotificacionCrearDestino.class.getName());
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		try {		
			...
			GestionDestiny.queueNotificationCrearDestino(codeNotificacion);			
			_logger.info("Exito");		
