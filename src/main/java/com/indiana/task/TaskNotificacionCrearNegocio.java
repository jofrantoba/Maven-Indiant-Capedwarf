...
public class TaskNotificacionCrearNegocio extends HttpServlet {
	private static final Logger _logger = Logger.getLogger(TaskNotificacionCrearNegocio.class.getName());
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		try {		
			...
			GestionBussines.queueNotificationCrearNegocio(codeNotificacion);
			_logger.info("Exito");		
