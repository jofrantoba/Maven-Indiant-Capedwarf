...
public class TaskNotificacionConquistarNegocio extends HttpServlet {
	private static final Logger _logger = Logger.getLogger(TaskNotificacionConquistarNegocio.class.getName());
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		try {		
			...
			GestionBussines.queueNotificationConquistarNegocio(codeNotificacion);
			_logger.info("Exito");		
