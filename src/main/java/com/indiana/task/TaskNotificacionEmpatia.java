...
public class TaskNotificacionEmpatia extends HttpServlet {
	private static final Logger _logger = Logger.getLogger(TaskNotificacionEmpatia.class.getName());

	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
		String strCallResult = "";
		response.setContentType("text/plain");				
		try {		
			String codeEmpatia= request.getParameter("codeEmpatia");			
			GestionMiembro.queueNotificationEmpatia(codeEmpatia);					
			_logger.info("Exito");
