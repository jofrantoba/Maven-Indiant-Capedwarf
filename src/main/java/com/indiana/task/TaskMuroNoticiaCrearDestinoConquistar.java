...
public class TaskMuroNoticiaCrearDestinoConquistar extends HttpServlet {
	private static final Logger _logger = Logger.getLogger(TaskMuroNoticiaCrearDestinoConquistar.class.getName());
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		try {		
			...
			GestionDestiny.queueMuroNoticiaCrearDestinoConquistar(codeNoticia);	
			_logger.info("Exito");		
